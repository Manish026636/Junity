          ...
          <nav class="mt-4 -mx-3 space-y-6 ">
            ...
            <div class="space-y-3 ">
              <button class="flex border border-1 border-[#F0F0F0] items-center px-3 w-full py-3 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                ...
                <span class="mx-2 text-sm font-medium">Roll Call</span>
              </button>
              ...
              <button class="flex border border-1 border-[#F0F0F0] items-center px-3 w-full py-3 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                ...
                <span class="mx-2 text-sm font-medium">GSL</span>
              </button>
              ...
              <button class="flex border border-1 border-[#F0F0F0] items-center px-3 w-full py-3 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                ...
                <span class="mx-2 text-sm font-medium">Moderated Cocus</span>
              </button>
              <button class="flex border border-1 border-[#F0F0F0] items-center px-3 w-full py-3 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span class="mx-2 text-sm font-medium">Unmoderated Cocus</span>
              </button>
            </div>
          </nav>
        </div>
